...
public class TTSGenerator {
  ...
  public static void speak(String text, PlayerEntity player, World world) {
    ...
    // for (Voice v : voices) {
    // System.out.println("Voice: " + v.getName());
    // }

    // Voice voice = voices[1]; // Default to the first voice
    ...
    // voice.allocate();
    // ByteArrayAudioPlayer audioPlayer = new
    // ByteArrayAudioPlayer(AudioFileFormat.Type.WAVE);
    ...
    try {
      ...
      System.out.println("WE DEFINITELY HAVE THE ELERVENLABS KEY: " + ELEVENLABS_API_KEY);
      RequestBody body = RequestBody.create(json.toString(), MediaType.get("application/json"));
      Request request = new Request.Builder()
          .url("https://api.elevenlabs.io/v1/text-to-speech/JBFqnCBsd6RMkjVDRZzb?output_format=pcm_16000")
